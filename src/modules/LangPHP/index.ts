...
import phpsetvhostversions from './phpsetvhostversions';
    ...
    export { phpgetdomainhandler, phpgetimpacteddomains, phpgetinstalledversions, phpgetsystemdefaultversion, phpgetvhostversions, phpinigetuserbasicdirectives, phpinigetusercontent, phpinigetuserpaths, phpinisetuserbasicdirectives, phpinisetusercontent, phpsetvhostversions,  };