...
import ishordeenabled from './ishordeenabled';
    ...
    export { disablesharedglobaladdressbook, enablesharedglobaladdressbook, getcalendarcontactsconfig, hassharedglobaladdressbook, isdavserviceenabled, ishordeenabled,  };